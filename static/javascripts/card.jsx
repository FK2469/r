  ...
  render() {
    ...
    return (
      <div>
        <div id="card" className={show_card}>
          <div id="card-info">
            ...
            <div className="file-meta">
              <h2 id="filename" className="filename">
                {this.props.filename}
              </h2>
            ...
            <div id="action-area">
              <a href={this.props.url_d} id="download-link">
                Download
              </a>
              {this.props.type !== "binary" && (
                <a href={this.props.url_i} id="play-link">
                  Preview
                </a>
              )}
            </div>
        ...
        <ImageCard
          show_image_card={show_image_card}
          url_i={this.props.url_i}
          image_link_input={this.props.url_s}
          quoteurl={this.props.quoteurl}
        />
      </div>
    );
  }
...
export class ImageCard extends React.Component {
  ...
  render() {
    var qrURL =
      "http://qr.liantu.com/api.php?el=m&w=200&m=10&text=" +
      this.props.image_link_input;
    return (
      <div>
        {this.props.show_image_card && (
          ...
          >
            <div
              id="image-preview"
              style={this.state.zoomed ? { maxHeight: "" } : null}
        ...
        {!this.state.zoomed && this.props.image_link_input !== "" ? (
          <img className="qrcode" src={qrURL} width="150" height="150" />
        ) : null}
      </div>
    );
  }
